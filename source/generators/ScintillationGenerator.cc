...
_nphotons(1000000)
{
  ...
  G4GenericMessenger::Command& xpos = _msg->DeclareProperty("xpos", _position_X, "Set x position");
  G4GenericMessenger::Command& ypos = _msg->DeclareProperty("ypos", _position_Y, "Set y position");
  G4GenericMessenger::Command& zpos = _msg->DeclareProperty("zpos", _position_Z, "Set z position");
  G4GenericMessenger::Command& nphs = _msg->DeclareProperty("nphotons", _nphotons, "Set number of photons");
