...
namespace nexus {
  ...
  private:
    ...
    G4bool _store_traj;    ///< Should we store the trajectories in the event?
    G4bool _store_Ihits;   ///< Should we store the ionization hits in the event?
    G4bool _store_PMThits; ///< Should we store the PMT hits in the event?
