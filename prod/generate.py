...
macs_path = "/home/gonzalo/data/NEXT/ELsim/{region}/macs/".format(**locals())
data_path = "/home/gonzalo/data/NEXT/ELsim/{region}/data/".format(**locals())
jobs_path = "/home/gonzalo/data/NEXT/ELsim/{region}/jobs/".format(**locals())
logs_path = "/home/gonzalo/data/NEXT/ELsim/{region}/logs/".format(**locals())
